...
// guard added to the subtitle claims() func: a "subtitle" file larger
// than the few-MiB ceiling must not be claimed at all, so a hostile
// multi-GB .srt is never opened.
