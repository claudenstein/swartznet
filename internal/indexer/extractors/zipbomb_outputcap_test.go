...
// input, the decompressed <w:t> text was accumulated into an unbounded
// strings.Builder. With the output guard, a small maxBytes budget caps
// the extracted text regardless of how much body text the document
// contains.
