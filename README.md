...
| M3c — Outbound Query fan-out + result aggregation | 🚧 Next | `Query()` method that sends to all search-capable peers with a txid and collects responses on a per-query channel. |
